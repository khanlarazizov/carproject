...
<form action="{{route('updatecusPost',$customerInfo->id)}}" method="post">
    ...
    <div action="insert" class="row">
        ...
        <div class="col-3">
            ...
            <a class="btn btn-primary" href="{{route('index')}}" role="button">Imtina</a>
        </div>
    </div>
    <div class="row">
        <div class="col-6">
            <label for="controlFname">Ad</label>
            <input type="text" class="form-control" value="{{$customerInfo->name}}" required="" aria-label="First name"
                   id="controlFname" name="name">
        </div>
        <div class="col-6">
            <label for="controlLname">Soyad</label>
            <input type="text" class="form-control" required="" value="{{ $customerInfo->surname}}"
    ...
    <div class="row">
        <div class="col-6">
            ...
            <div class="input-group date" id="datepicker">
                <input type="text" class="form-control" required="" value="{{\Carbon\Carbon::parse($customerInfo->birthdate)->format('m/d/Y') }}"
                       name="birthdate">
